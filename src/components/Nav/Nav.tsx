  ...
  return (
    <>
      ...
      >
        ...
        <Link href="/">
          <Image src="/assets/logos/logo-white.png" onClick={() => setIsOpen(false)} alt="Logo Pixel Creatives" className="h-fit w-auto object-cover object-center" width={300} height={100} />
        </Link>
        </div>
